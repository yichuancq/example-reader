    ...
    <div class="main">
        ...
        <div @keyup.enter="search">
            <el-row :gutter="10">
                ...
                <el-col :xs="24" :sm="12" :lg="4" class="margin-top-10">
                    <el-date-picker v-model="params.startTime" type="date" placeholder="操作开始日期" :editable="false"></el-date-picker>
                </el-col>
                <el-col :xs="24" :sm="12" :lg="4" class="margin-top-10">
                    <el-date-picker v-model="params.endTime" type="date" placeholder="操作结束日期" :editable="false"></el-date-picker>
                </el-col>
        ...
        loadData(params, page) {
            ...
            if (isEmpty) {
                ...
                if (typeof params.startTime === "object") {
                    newParams.startTime = this.getDateFormat(
                        params.startTime,
                        "yyyy-MM-dd"
                    );
                } else {
                ...
                if (typeof params.endTime === "object") {
                    newParams.endTime = this.getDateFormat(
                        params.endTime,
                        "yyyy-MM-dd"
                    );
                } else {
                ...
                let data = Object.assign({}, newParams, page);
                this.$http
                    .post(
                        "/api/reader/GoodsCirculationController/queryLastGoodsCirculationByCondition",
                        data
                    )
                    .then(res => {
                        if (res.data.code === "000") {
                            ...
                            this.productList =
                                res.data.result.lastGoodsCirculationList;
